...
import { contractService } from '../../services/tourism-facility/contract.service';
...
export const fetchContract = createAsyncThunk('contract/fetchContract', async (id: number) => {
