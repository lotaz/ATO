import { CalendarOutlined, EyeOutlined, ShopOutlined } from '@ant-design/icons';
...
const CertificationList = () => {
  ...
  useEffect(() => {
    const fetchCertifications = async () => {
      try {
        setLoading(true);
        const response = await get('/facility-certifications');
  ...
  const handleOnClick = (certId: any) => {
    navigate(`${CONTENT_MODERATOR_URLs.FACILITY_CER.DETAILS}?id=${certId}`);
  };
